...
public class RoundRobinScheduler {
    ...
    private static void printCloudletList(List<Cloudlet> list) {
        ...
        try (FileWriter writer = new FileWriter("src-analysis/RoundRobin/cloudlet_output.csv")) {
            // Write the header in the required CSV format
            ...
            for (Cloudlet value : list) {
                ...
                if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS) {
                    ...
                    // Write data to CSV in the required format
                    writer.append(cloudlet.getCloudletId() + ",");
                    writer.append("SUCCESS" + ",");
                    writer.append(cloudlet.getResourceId() + ",");
                    writer.append(cloudlet.getVmId() + ",");
                    writer.append(responseTime + ",");
                    writer.append(cloudlet.getExecStartTime() + ",");
                    writer.append(cloudlet.getFinishTime() + "\n");
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
